...
namespace GiveAidCharity.Models.Main
{
    public class Project
    {
        ...
        [Url] [Required] public string CoverImg { get; set; }
        [Required] public string ContentPart1 { get; set; }
        [Required] public string ContentPart2 { get; set; }

        [Required] [Range(0, double.MaxValue)] public double Goal { get; set; }
        [Required] [Range(0, double.MaxValue)] public double CurrentFund { get; set; }
        ...
        public enum ProjectStatusEnum
        {
            ...
            Ongoing = 2,
            Success = 3,
            //if expired but fund not enough
            Suspended = -1,
